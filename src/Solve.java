...
public class Solve {
 ...
 public void printSolve (Board in) throws NullBoardException {
  ...
  try {
   ...
   Board[] childArray = in.getIntelligentChildren(); //Generate all valid children.
 ...
 public Board [] solveWithStats(Board in) throws NullBoardException {
  try { numberOfSolutions = countSol(in);
  System.out.println("There are " + numberOfSolutions);
  } //Stores the number of solutions in the static variable.
